...
class _GeolocatorWidgetState extends State<OnePage>
  ...
  Future<void> _getCurrentPosition() async {
    ...
    _updatePositionList(
      _PositionItemType.position_current,
      position.toString(),
    );
  }
  ...
  void _toggleListening() {
    if (_positionStreamSubscription == null) {
      ...
      _positionStreamSubscription = positionStream.handleError((error) {
        ...
        _updatePositionList(
          _PositionItemType.position_loop,
          position.toString(),
        );
      });
  ...
  void _getLastKnownPosition() async {
    ...
    if (position != null) {
      _updatePositionList(
        _PositionItemType.position_last,
        position.toString(),
      );
    } else {
      _updatePositionList(
...
enum _PositionItemType { log, position_loop, position_current, position_last }

extension _PositionItemTypeExt on _PositionItemType {
  String get typeLabel {
    switch (this) {
      case _PositionItemType.log:
        return 'log';
      case _PositionItemType.position_loop:
        return 'position_loop';
      case _PositionItemType.position_current:
        return 'position_curr';
      case _PositionItemType.position_last:
...
class _PositionItem {
  ...
  @override
  String toString() {
    return '${type.typeLabel} : $displayValue';
  }
}
